...
const HOMEBREW_CASK_API_URL: &str = "https://formulae.brew.sh/api/cask/wildex.json";
const LATEST_RELEASE_URL: &str = "https://api.github.com/repos/karanocave/codex/releases/latest";
