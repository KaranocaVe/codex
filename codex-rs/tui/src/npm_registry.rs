...
pub(crate) const PACKAGE_URL: &str = "https://registry.npmjs.org/@karanocave%2fwildex";
    ...
    fn version_json(version: &str) -> serde_json::Value {
        serde_json::json!({
            "dist": {
                ...
                "tarball": format!("https://registry.npmjs.org/@karanocave/wildex/-/wildex-{version}.tgz"),
            }
        })
    }
