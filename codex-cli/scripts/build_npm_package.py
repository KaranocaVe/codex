#!/usr/bin/env python3
"""Stage and optionally package the Wildex npm module."""
...
CODEX_NPM_NAME = "@karanocave/wildex"

# `npm_name` is the local optional-dependency alias consumed by `bin/wildex.js`.
# The underlying package published to npm is always `@karanocave/wildex`.
CODEX_PLATFORM_PACKAGES: dict[str, dict[str, str]] = {
    "wildex-linux-x64": {
        "npm_name": "@karanocave/wildex-linux-x64",
        "npm_tag": "linux-x64",
    ...
    "wildex-linux-arm64": {
        "npm_name": "@karanocave/wildex-linux-arm64",
        "npm_tag": "linux-arm64",
    ...
    "wildex-darwin-x64": {
        "npm_name": "@karanocave/wildex-darwin-x64",
        "npm_tag": "darwin-x64",
    ...
    "wildex-darwin-arm64": {
        "npm_name": "@karanocave/wildex-darwin-arm64",
    ...
    "wildex-win32-x64": {
        "npm_name": "@karanocave/wildex-win32-x64",
        "npm_tag": "win32-x64",
    ...
    "wildex-win32-arm64": {
        "npm_name": "@karanocave/wildex-win32-arm64",
        "npm_tag": "win32-arm64",
...
PACKAGE_EXPANSIONS: dict[str, list[str]] = {
    "wildex": ["wildex", *CODEX_PLATFORM_PACKAGES],
}

PACKAGE_NATIVE_COMPONENTS: dict[str, list[str]] = {
    "wildex": [],
    "wildex-linux-x64": ["bwrap", "wildex", "rg"],
    "wildex-linux-arm64": ["bwrap", "wildex", "rg"],
    "wildex-darwin-x64": ["wildex", "rg"],
    "wildex-darwin-arm64": ["wildex", "rg"],
    "wildex-win32-x64": ["wildex", "rg", "codex-windows-sandbox-setup", "codex-command-runner"],
    "wildex-win32-arm64": ["wildex", "rg", "codex-windows-sandbox-setup", "codex-command-runner"],
...
COMPONENT_DEST_DIR: dict[str, str] = {
    ...
    "wildex": "wildex",
    "codex-responses-api-proxy": "codex-responses-api-proxy",
    "codex-windows-sandbox-setup": "wildex",
    "codex-command-runner": "wildex",
    "rg": "path",
}


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build or stage the Wildex CLI npm package.")
    parser.add_argument(
        "--package",
        choices=PACKAGE_CHOICES,
        default="wildex",
        help="Which npm package to stage (default: wildex).",
    )
    parser.add_argument(
        "--version",
        ...
        if release_version:
            ...
            if package == "wildex":
                print(
                    ...
                    "Verify the CLI:\n"
                    f"    node {staging_dir_str}/bin/wildex.js --version\n"
                    f"    node {staging_dir_str}/bin/wildex.js --help\n\n"
                )
...
def prepare_staging_dir(staging_dir: Path | None) -> tuple[Path, bool]:
    ...
    temp_dir = Path(tempfile.mkdtemp(prefix="wildex-npm-stage-"))
...
def stage_sources(staging_dir: Path, version: str, package: str) -> None:
    ...
    if package == "wildex":
        ...
        shutil.copy2(CODEX_CLI_ROOT / "bin" / "wildex.js", bin_dir / "wildex.js")
    ...
    if package == "wildex":
        ...
        package_json["optionalDependencies"] = {
            ...
            for platform_package in PACKAGE_EXPANSIONS["wildex"]
            if platform_package != "wildex"
        }
...
def run_npm_pack(staging_dir: Path, output_path: Path) -> Path:
    ...
    with tempfile.TemporaryDirectory(prefix="wildex-npm-pack-") as pack_dir_str:
